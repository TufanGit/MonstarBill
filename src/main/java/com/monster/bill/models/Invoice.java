...
@Entity
@Audited
@Table(name = "invoice", uniqueConstraints = {@UniqueConstraint(columnNames = {"subsidiaryId", "supplierId", "invoiceNo"})})
public class Invoice implements Cloneable {
	...
	private Long supplierId, subsidiaryId, poId, locationId;
	private String invoiceNo, invStatus, paymentTerm, integratedId, currency, billTo, shipTo, invoiceCode, invoiceSupplyNumber;
