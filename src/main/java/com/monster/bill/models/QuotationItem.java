...
public class QuotationItem implements Cloneable {
	...
	public QuotationItem(Long id, Long quotationId, String rfqNumber, Long itemId, String name, String description, String uom, Integer quantity, Date receivedDate, String remarks,
	...
	public QuotationItem(String rfqNumber, Long quotationId, Long itemId, String itemName, Integer quantity, String uom, String prNumber, Long prLocationId, String locationName, Long prId) {
		this.rfqNumber = rfqNumber;
		this.quotationId = quotationId;
		this.itemId = itemId;
