...
public class Employee implements Cloneable {
	...
	public Employee(Long id, String firstName, String middleName, String lastName, String employeeNumber, String contactNumber, String designation, boolean isActive, String fullName) {
		this.id = id;
