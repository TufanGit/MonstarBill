...
@AllArgsConstructor
@Entity
@Table(	name = "quotation_analysis_items")
@ToString
@Audited
...
//	private String prNumber;
	...
	public QuotationAnalysisItem(Long id, String qaNumber, Long itemId, String name, String description, String integratedId, Long accountCode,  String uom, 
			Integer quantity, Double ratePerUnit, Double actualRate, OffsetDateTime recievedDate) {
		this.id = id;
	...
	public QuotationAnalysisItem(Long qaId, String qaNumber, Long quantity) {
		this.qaId = qaId;
		this.qaNumber = qaNumber;
