...
//	private String itemDescription;
	...
	public PurchaseOrderItem(Long id, String poNumber, Long poId, Long itemId, Double quantity, Double rate, Long accountId, Double amount, Long taxGroupId, Double taxAmount, Date receivedByDate, Long prId, 
			Long shipToLocationId, String shipToLocation, String department, String memo, String itemName, String itemDescription, String itemUom, String itemIntegratedId, String prNumber) {
		this.id = id;
		this.poId = poId;
