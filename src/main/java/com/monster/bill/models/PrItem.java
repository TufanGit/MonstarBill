...
//	private String poNumber;
	...
	public PrItem(Long id, Long itemId, Long prId, String prNumber, String name, String description, String uom, Integer quantity,
			Double rate, Double estimatedAmount, Date receivedDate, Long poId, String memo) {
		this.id = id;
		this.itemId = itemId;
		this.prId = prId;
	...
	public PrItem(Long prId, Long itemId, String name, String description, String integratedId, String uom, Integer quantity,
			Date receivedDate, String prNumber, String department, Double rate, Long accountId, Long locationId, String prLocationName) {
		this.prId = prId;
		this.itemId = itemId;
		this.itemName = name;
		this.itemDescription = description;
