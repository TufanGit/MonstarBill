...
//	@Column(nullable = false)
	...
	public Supplier(Long id, String name, String vendorNumber, String vendorType, boolean isActive, String subsidiaryName, String contactName, String contactNumber, String approvalStatus) {
		this.id = id;
		this.name = name;
