...
public class FiscalCalenderDaoImpl implements FiscalCalenderDao {
	...
	public static final String GET_FISCAL_CALENDER = "select new com.monster.bill.models.FiscalCalender(f.id, f.name, f.startMonth, f.endMonth, s.name as subsidiaryName, fa.yearName as yearName, f.isActive ) "
