...
public class GrnDaoImpl implements GrnDao {
	...
	public static final String GET_GRN = "select new com.monster.bill.models.Grn(gr.id, gr.grnNumber, gr.subsidiaryId, gr.locationId, gr.poNumber, gr.grnDate, gr.supplierId, sub.name as subsidiaryName, l.locationName as locationName, su.name as supplierName) "
