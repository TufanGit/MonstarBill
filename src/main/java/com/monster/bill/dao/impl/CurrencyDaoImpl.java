...
import com.monster.bill.dao.CurrencyDao;
...
public class CurrencyDaoImpl implements CurrencyDao {
	...
	public static final String GET_CURRENCY = "select new com.monster.bill.models.Currency(c.id, c.name, c.code, c.isInactive) "
			+ " FROM Currency c " 
			+ " WHERE 1=1 ";
