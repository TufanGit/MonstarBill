...
import com.monster.bill.dao.ApprovalPreferenceDao;
...
public class ApprovalPreferenceDaoImpl implements ApprovalPreferenceDao {
	...
	public static final String GET_APPROVAL_PREFERENCE = "SELECT new com.monster.bill.models.ApprovalPreference(ap.id, aps.id, aps.sequenceId, apc.level, ap.approvalType) FROM ApprovalPreference ap "
			...
			+ " WHERE 1 = 1 ";
	public static final String GET_APPROVAL_PREFERENCE_LIST = "SELECT new com.monster.bill.models.ApprovalPreference(ap.id, ap.subsidiaryId, ap.approvalType, ap.recordType, ap.subType, s.name as subsidiaryName ) FROM ApprovalPreference ap "
