...
public class EmployeeDaoImpl implements EmployeeDao{
	...
	public static final String GET_ALL_EMPLOYEES = " SELECT new com.monster.bill.models.Employee(e.id, e.firstName, e.middleName, e.lastName, e.employeeNumber, ec.mobile, e.designation, e.isActive, e.fullName) from Employee e "
