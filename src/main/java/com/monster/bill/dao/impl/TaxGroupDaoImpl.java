...
public class TaxGroupDaoImpl implements TaxGroupDao{
	...
	public static final String GET_TAX_GROUP = "select new com.monster.bill.models.TaxGroup(t.id, t.subsidiaryId, t.country, t.name, t.description, s.name as subsidiaryName, t.isActive) "
