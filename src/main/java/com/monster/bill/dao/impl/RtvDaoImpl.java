...
public class RtvDaoImpl implements RtvDao{
	...
	public static final String GET_RTV =  " select new com.monster.bill.models.Rtv(r.id, s.name, r.createdDate, r.rtvNumber, sup.name, r.grnNumber, r.rtvDate) from Rtv r "
