...
public class QuotationDaoImpl implements QuotationDao {
	...
	public static final String GET_QUOTATIONS = " select new com.monster.bill.models.Quotation(q.id, s.name, q.rfqDate, q.rfqNumber, q.bidOpenDate, q.bidCloseDate, q.bidType, q.currency, q.status) " 
			+ " FROM Quotation q " 
