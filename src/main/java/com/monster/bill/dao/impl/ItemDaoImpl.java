...
public class ItemDaoImpl implements ItemDao {
	...
	public static final String GET_ITEM = "select new com.monster.bill.models.Item(i.id, i.name, i.description, i.category, i.uom, i.isActive, s.name) from Item i inner join Subsidiary s ON i.subsidiaryId = s.id WHERE 1=1 ";
