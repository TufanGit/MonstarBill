...
import com.monster.bill.dao.LocationDao;
...
public class LocationDaoImpl implements LocationDao {
	...
	public static final String GET_LOCATION = "select new com.monster.bill.models.Location(b.id, b.locationName, b.locationType, b.effectiveFrom, s.name as subsidiaryName, a.locationName as parentLocationName, b.parentLocationId, b.subsidiaryId) "
			+ " from Location b "
