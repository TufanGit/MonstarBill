...
public class CustomRolesDaoImpl implements CustomRolesDao {
	...
	public static final String GET_ROLES = "select new com.monster.bill.models.CustomRoles(r.id, r.subsidiaryId,r.isActive, r.name, r.createdDate, r.createdBy, s.name) from CustomRoles r"
