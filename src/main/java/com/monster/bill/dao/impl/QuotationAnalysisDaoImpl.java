...
public class QuotationAnalysisDaoImpl implements QuotationAnalysisDao {
	...
	public static final String GET_QUOTATIONS_ANALYSIS = " select new com.monster.bill.models.QuotationAnalysis(qa.id, qa.qaNumber, qa.rfqId, qa.subsidiaryId, qa.qaDate, q.bidType as bidType, "
