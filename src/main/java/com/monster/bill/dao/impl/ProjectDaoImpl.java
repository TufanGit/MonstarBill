...
import com.monster.bill.dao.ProjectDao;
...
public class ProjectDaoImpl implements ProjectDao {
	...
	public static final String GET_PROJECT = "select new com.monster.bill.models.Project(p.id, p.name, p.projectId, p.schedulingStartDate, p.schedulingEndDate, s.name as subsidiaryName) "
