...
//	public static final String GET_ACCOUNT = "select new com.monster.bill.models.Account(a.id, a.code, a.description, a.type, a.is_inactive, ) "
//			+ " from Account a  WHERE 1=1 ";
	...
	+ " from mbl.account a "
	+ " LEFT JOIN mbl.account_subsidiary s ON a.id = s.account_id "
	+ " where a.is_deleted is false and s.is_deleted is false ";
	
	// + " group by a.id, a.code, a.description, a.type, a.is_inactive ";
	public static final String GET_ACCOUNT_COUNT = "select count(*) from mbl.account a "
			+ " LEFT JOIN mbl.account_subsidiary s ON a.id = s.account_id "
			+ " where a.is_deleted is false and s.is_deleted is false ";
