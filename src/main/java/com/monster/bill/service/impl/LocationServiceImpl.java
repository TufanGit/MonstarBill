...
import com.monster.bill.dao.impl.LocationDaoImpl;
...
import com.monster.bill.repository.LocationAddressRepository;
import com.monster.bill.repository.LocationHistoryRepository;
import com.monster.bill.repository.LocationRepository;
import com.monster.bill.repository.SubsidiaryRepository;
import com.monster.bill.service.LocationService;
...
public class LocationServiceImpl implements LocationService {
	...
	public Location getLocationById(Long id) {
		...
		if (location.get().getSubsidiaryId() != null) {
			Optional<Subsidiary> subsidiary = this.subsidiaryRepository.findByIdAndIsDeleted(location.get().getSubsidiaryId(), false);
			if (subsidiary.isPresent()) {
				location.get().setSubsidiaryName(subsidiary.get().getName());				
			}
		}
