...
import com.monster.bill.models.ApprovalRoutingPreference;
...
import com.monster.bill.repository.AccountingPreferencesRepository;
import com.monster.bill.repository.ApprovalRoutingPreferenceRepository;
import com.monster.bill.repository.CostingPreferencesRepository;
import com.monster.bill.repository.GeneralPreferencesRepository;
import com.monster.bill.repository.NumberingPreferencesRepository;
import com.monster.bill.repository.OtherPreferenceRepository;
import com.monster.bill.repository.PreferencesHistoryRepository;
...
// save the Numbering Preferences
	private void saveNumberingPreferences(Long preferenceId, NumberingPreferences numberingPreferences) {
		...
		if (numberingPreferences.getId() == null) {
			...
			// Get the existing object using the deep copy
			oldNumberingPreferences = this.numberingPreferencesRepository
					.findByIdAndIsDeleted(numberingPreferences.getId(), false);
