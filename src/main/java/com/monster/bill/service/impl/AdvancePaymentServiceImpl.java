...
import com.monster.bill.repository.AdvancePaymentApplyRepository;
import com.monster.bill.repository.AdvancePaymentHistoryRepository;
...
import com.monster.bill.service.AdvancePaymentService;
...
public class AdvancePaymentServiceImpl implements AdvancePaymentService {
	...
	public AdvancePayment save(AdvancePayment advancePayment) {
		...
		if (advancePayment.getId() == null) {
			...
			String documentSequenceNumber = this.documentSequenceService.getDocumentSequenceNumbers(transactionalDate,
	...
	public Boolean sendForApproval(Long id) {
		...
		try {
			...
			componentUtility.sendEmailByApproverId(advancePayment.get().getNextApprover(), FormNames.ADVANCE_PAYMENT.getFormName());
	...
	private boolean findIsApprovalRoutingActive(Long subsidiaryId) {
		return this.componentUtility.findIsApprovalRoutingActive(subsidiaryId, FormNames.ADVANCE_PAYMENT.getFormName());
	}
