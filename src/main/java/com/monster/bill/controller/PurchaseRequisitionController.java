...
//	}
	...
	public ResponseEntity<List<PrItem>> findUnprocessedItemsByPrId(@RequestParam Long prId) {
	...
	public ResponseEntity<List<PrItem>> findUnprocessedItemsByPrIds(@RequestBody List<Long> prIds) {
		log.info("Get Purchase Requisition for prNumbers :: " + prIds);
		List<PrItem> prItems = purchaseRequisitionService.findUnprocessedItemsByPrIds(prIds);
