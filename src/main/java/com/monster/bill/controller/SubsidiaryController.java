...
import com.monster.bill.service.SubsidiaryService;
...
public class SubsidiaryController {
	 ...
	 */
	@GetMapping("/get/all")
	public ResponseEntity<PaginationResponse> getAllSubsidiaries(@RequestParam(required = false) Date startDate, @RequestParam(required = false) Date endDate, 
			@RequestParam(defaultValue = "0") int pageNumber, @RequestParam(defaultValue = "300") int pageSize, @RequestParam(defaultValue = "id") String sortColumnName, 
			@RequestParam(defaultValue = "desc") String sortOrder) {
		return new ResponseEntity<>(subsidiaryService.getSubsidiaries(startDate, endDate, pageNumber, pageSize, sortColumnName, sortOrder), HttpStatus.OK);
	}
	...
	public ResponseEntity<List<Subsidiary>> getAllSubsidiariesFilter(@RequestParam String startDate, @RequestParam String endDate) {
	...
	public ResponseEntity<List<SubsidiaryHistory>> findHistoryById(@RequestParam Long subsidiaryId, @RequestParam(defaultValue = "10") int pageSize, @RequestParam(defaultValue = "0") int pageNumber, @RequestParam(defaultValue = "id") String sortColumn) {
		...
		List<SubsidiaryHistory> subsidiaryHistoris = this.subsidiaryService.findHistoryBySubsidiaryId(subsidiaryId, pageable);
