...
public class DocumentSequenceController {
	...
	public ResponseEntity<String> getDocumentSequenceNames(@RequestParam String transactionalDate, @RequestParam Long subsidiaryId, @RequestParam String type,
			@RequestParam boolean isDeleted) {
		log.info("Document sequence filterd .");
		String documentSequences = documentSequenceService.getDocumentSequenceNumbers(transactionalDate, subsidiaryId,
				type, false);
