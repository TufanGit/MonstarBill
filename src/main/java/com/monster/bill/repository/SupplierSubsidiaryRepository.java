...
public interface SupplierSubsidiaryRepository extends JpaRepository<SupplierSubsidiary, String> {
	...
	public Optional<SupplierSubsidiary> findBySupplierIdAndIsDeleted(Long supplierId, boolean isDeleted);
}
