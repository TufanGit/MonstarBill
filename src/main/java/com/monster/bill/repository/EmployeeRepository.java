...
public interface EmployeeRepository extends JpaRepository<Employee, String> {
	...
	@Query("select new com.monster.bill.models.Employee(id, concat(firstName,' ',lastName) as name) from Employee Where subsidiaryId = :subsidiaryId and isDeleted = :isDeleted order by firstName asc ")
	...
	@Query(" Select new com.monster.bill.payload.response.IdNameResponse(e.id, e.fullName) "
			+ " FROM Employee e "
