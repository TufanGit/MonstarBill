...
public interface LocationRepository extends JpaRepository<Location, String> {
	...
	@Query("select new com.monster.bill.models.Location(locationName, id) from Location Where subsidiaryId = :subsidiaryId AND isDeleted = :isDeleted ")
	...
	@Query("select new com.monster.bill.models.Location(l.locationName, l.id) from Location l Where l.subsidiaryId in :subsidiaryId AND isDeleted = :isDeleted ")
	...
	@Query("select new com.monster.bill.models.Location(locationName, id) from Location Where id IN :ids AND isDeleted = false ")
