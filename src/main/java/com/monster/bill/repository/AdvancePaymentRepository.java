...
public interface AdvancePaymentRepository extends JpaRepository<AdvancePayment, String> {
	...
	@Query(" select new com.monster.bill.models.AdvancePayment(a.id, a.advanceAmount, a.paymentAmount, a.prePaymentNumber, a.subsidiaryId, a.supplierId, a.prePaymentDate, a.rejectedComments, a.memo, a.status, a.unappliedAmount, "
			+ " s.name as subsidiaryName, su.name as supplierName) from AdvancePayment a "
	...
	@Query(" select new com.monster.bill.models.AdvancePayment(a.id, a.prePaymentNumber, a.subsidiaryId, a.supplierId, a.prePaymentDate, a.currency,"
