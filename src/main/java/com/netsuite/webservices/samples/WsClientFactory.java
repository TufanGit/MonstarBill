 ...
 *//**
	 * <p>
	 * Factory for creating fully initialized web services client.
	 * </p>
	 * <p>
	 ...
	 *//*
		 ...
		 * 
		 * public static WsClient getWsClient(Properties properties, URL endpointUrl)
		 * throws MalformedURLException, RemoteException { WsClient client = new
		 * WsClient(endpointUrl == null ? properties.getWebServicesUrl() : endpointUrl);
